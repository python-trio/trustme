...
latex_documents = [
    (master_doc, 'trustme.tex', 'trustme Documentation',
...
man_pages = [
    (master_doc, 'trustme', 'trustme Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'trustme', 'trustme Documentation',
     author, 'trustme', 'One line description of project.',
     'Miscellaneous'),
]
